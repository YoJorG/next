...
function Footer() {
	...
	return (
		<div className='bg-white pt-4 sm:pt-10 lg:pt-12 border-t border-gray-300'>
			<footer className='mx-auto max-w-screen-2xl px-4 md:px-8'>
				<div className='flex flex-col items-center justify-between gap-4 border-t border-b py-6 md:flex-row'>
					<nav className='flex flex-wrap justify-center gap-x-4 gap-y-2 md:justify-start md:gap-6'>
						<Link href='#' className='text-gray-500 transition duration-100 hover:text-blue-600 active:text-indigo-600'>
							O nas
						</Link>
						<Link
							href='/#oferta'
							className='text-gray-500 transition duration-100 hover:text-blue-600 active:text-indigo-600'
						>
							Oferta
						</Link>
						<Link href='#' className='text-gray-500 transition duration-100 hover:text-blue-600 active:text-indigo-600'>
